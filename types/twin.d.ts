...
import { css as cssImport, stitches as config, styled as stitchesStyled } from '../stitches.config';
    ...
    >(
        ...composers: {
            [K in keyof Composers]: string extends Composers[K] // Strings, React Components, and Functions can be skipped over
                ? Composers[K]
                : Composers[K] extends string | ComponentType<unknown> | Util.Function
                ? Composers[K]
                : RemoveIndex<CSS> & {
