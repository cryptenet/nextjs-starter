...
-   Styled with [Tailwind CSS](https://tailwindcss.com/), [Framer Motion](https://www.framer.com/motion/), [Twin](https://github.com/ben-rogerson/twin.macro)
    and [Stitches](https://stitches.dev/)
